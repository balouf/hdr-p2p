...
#let title-page() = {
  ...
  text(size: 1.9em, )[
    #smallcaps[#strong[U]niversité #strong[P]ierre et #strong[M]arie #strong[C]urie]
  ]

  v(1fr)


  smallcaps[--- #strong[UPMC] --- #strong[P]aris 6 ---]

  v(1fr)

  text(size: 1.5em, weight: "bold")[#t([HABILITATION À\ DIRIGER DES RECHERCHES], [HABILITATION TO\ SUPERVISE RESEARCH])]
  ...
  table(
    ...
    [#smallcaps[#t([Domaine], [Domain])]], [: *#thesis-domain*],
  )
...
#let back-cover() = {
  ...
  v(1fr)
  image("../figures/no_kieschnick.png", width: 5cm)
  v(1fr)
...
#let thesis-style(doc) = {
  ...
  // Citation style géré par le fichier CSL
