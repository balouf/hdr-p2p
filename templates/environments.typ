...
// Approximation
#let approximation = if _is-html {
  _html-thm("approximation", "Approximation", "thm-approximation")
} else {
  thmbox("approximation", "Approximation",
    fill: rgb("#ffbcbc"), stroke: rgb("#9E9E9E"), inset: 1em, radius: 4pt, base_level: 1)
}
