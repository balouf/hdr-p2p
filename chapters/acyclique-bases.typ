...
Le réseau à préférences lui-même est donc constitué d'un ensemble $P$ de $n$ pairs (ou noeuds) et d'un graphe $G=(P,E)$. Les préférences sont indiquées par une matrice de valeurs $m$ et les quotas par un vecteur $b$.
